                  ...
                  <div class="p-md-2 p-lg-3">
                    ...
                    <div class="py-3">
                      ...
                      <div class="py-3 d-flex align-items-center">
                        ...
                        <p class="mb-0">
                          Youâve managed to add <span class="fw-semibold text-success">12% more products</span> in the last 30 days. Storeâs portfolio is growing!
                        </p>
                      </div>
                    </div>
                  </div>
        ...
        <div class="content py-0">
          <div class="row fs-sm">
            ...
            <div class="col-sm-6 order-sm-1 text-center text-sm-start">
              <a class="fw-semibold" href="https://1.envato.market/r6y" target="_blank">Dashmix 5.6</a> &copy; <span data-toggle="year-copy"></span>
            </div>
          </div>
        </div>
      </footer>
