          ...
          <div class="block block-rounded">
            <div class="block-header block-header-default">
              ...
              <div class="block-options">
                <button type="button" onclick="window.location.href='add_category.jsp'")" class="btn btn-sm btn-alt-primary d-block d-lg-inline-block mb-1">
                  <i class="si si-add"></i>Add Category
                </button>
